...
public interface CartMapper {
    ...
    Cart selectCartUseridAndProductId(@Param("userId") Integer userId,
     ...
     * 查询用户的购物车信息
     * */
    List <Cart> selectCartUserid(Integer userId);
     ...
     * 删除购物车某些商品
     * */
    int deleteByUseridArrAndProductIds(
